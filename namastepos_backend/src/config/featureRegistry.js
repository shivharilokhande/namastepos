...
const FEATURES = Object.freeze([
  ...
  },
  {
    ...
    group: 'Advanced',
    enforcement: 'ungated',
    why: 'There is no tenant API-key surface in the product: no key issuance, no key '
      + 'auth path, nothing that reads this key. Sold on Enterprise and delivering '
      + 'nothing. Either build it or stop granting it.',
  },
  {
    key: 'white_label',
    ...
    group: 'Advanced',
    enforcement: 'ungated',
    why: 'No white-label implementation exists. custom_branding (bill templates) is the '
      + 'real, enforced capability. Sold on Enterprise and delivering nothing.',
  },
]);
