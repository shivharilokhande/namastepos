...
Cohesion: 0.09
Nodes (23): isImpersonating(), MenuPage, ImpersonationBanner(), Layout(), navBottom, navGroups, NavItem, navTop (+15 more)
...
Cohesion: 0.06
Nodes (69): IngredientsPage, ModifierGroupsPage, StaffPage, DateInput, DateInputProps, _toDisplay(), _toISO(), Dialog (+61 more)
...
Cohesion: 0.04
Nodes (53): baseURL, guest, guestApi, GuestMenu, DashboardPage, GuestMenuPage, MarketplacePage, ReportsPage (+45 more)
...
Cohesion: 0.08
Nodes (26): asyncHandler, canDailyClosing, customerHistory, customerImportRowSchema, dailyClosing, EXPENSE_CATEGORIES, expenseRowSchema, expenseSvc (+18 more)
...
Cohesion: 0.04
Nodes (53): bootstrapAuth(), getToken(), AccountingPage, AccountingReportsPage, AggregatorsPage, App(), B2BInvoiceTemplatePage, BankReconcilePage (+45 more)

### Community 41 - "admin.ts"
Cohesion: 0.06
Nodes (30): AuditEvent, ComplianceSettings, Coupon, CronJobStat, Customer, CustomPlan, CustomPlanInput, CustomPlanLimits (+22 more)
...
Cohesion: 0.11
Nodes (18): Admin, adminLogout(), api, clearSession(), establishSession(), reportAuthProbe(), setAdminToken(), Layout() (+10 more)

### Community 47 - "namastepos_admin/src/components/ui/card.tsx"
Cohesion: 0.10
Nodes (29): adminApi, AttentionItem, Overview, Button, ButtonProps, buttonVariants, Card, CardContent (+21 more)
...
Cohesion: 0.06
Nodes (33): adjust, byId, cacheAll, categories, create, delete, ExpenseRepo, history (+25 more)
...
### Community 70 - "taxInvoiceController.js"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (29): database_service.dart, Dio, activePendingCount, _api, clearAll, _connSub, _db, deadLetterCount (+21 more)
...
### Community 84 - "BillingPage.tsx"
Cohesion: 0.14
Nodes (20): BillingPage, escapeHtml(), formatIstDateTime(), money(), printReceipt(), ReceiptLine, ReceiptTotals, BillingPage() (+12 more)
...
### Community 103 - "finalSprint.routes.js"
Cohesion: 0.11
...
Cohesion: 0.14
Nodes (13): Breach, Dsr, Grievance, BREACH_STATUS, CompliancePage(), DSR_STATUS, DSR_TYPE_LABEL, GRV_STATUS (+5 more)
...
Cohesion: 0.05
Nodes (76): apiError(), isAuthed(), RequireAuth(), useDebounce(), formatDate(), formatDateTime(), formatINR(), AdminTeamPage() (+68 more)
...
### Community 170 - "whatsapp-webhook.test.js"
Cohesion: 0.22
...
### Community 181 - "storageService.js"
Cohesion: 0.24
...
Cohesion: 0.16
Nodes (17): api, InventoryPage, CookieBanner(), close(), ensureSessionId(), record(), AdjustStockDialog(), fmtQty() (+9 more)
...
### Community 194 - "fulfilment2026.test.js"
Cohesion: 0.27
...
Cohesion: 0.11
Nodes (49): exitImpersonation(), setBusinessCache(), setSession(), ffApi, HelpCenterPage, ReferPage, WastagePage, Props (+41 more)
...
Cohesion: 0.15
Nodes (12): 1. Configure Google OAuth (one-time), 2. Run locally (Docker — easiest), 3. Run locally (without Docker), 4. Run tests, 📡 API surface, 🔐 Auth flow, 🗄 Database schema, 🚀 Deploy (+4 more)
...
Cohesion: 0.06
Nodes (39): ActionCenterPage, CaptainPage, OrdersPage, ReviewsPage, Props, STATUS_COLORS, TableRow, CartLine (+31 more)
...
### Community 304 - "SurgePage.tsx"
Cohesion: 0.43
Nodes (6): SurgePage, DAYS, hhmmToMin(), minToHHMM(), NewSurge(), SurgePage()
...
### Community 388 - "expenses-reports.test.js"
Cohesion: 0.29
...
### Community 391 - "aggregatorOutboundAdapter.js"
Cohesion: 0.24
